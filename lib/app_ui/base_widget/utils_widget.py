...
from PyQt5.QtWidgets import QWidget, QVBoxLayout, QLabel, QLineEdit, QPushButton, QGridLayout, QDesktopWidget
from PyQt5.QtGui import QIntValidator, QIcon, QFont
from PyQt5.QtCore import Qt, QEvent
from lib.core.utils_function import *
...
class buildHorizontalDivider(QLabel):
    def __init__(self):
        super().__init__()
